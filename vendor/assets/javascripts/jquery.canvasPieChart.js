/* 
 Document   : jquery.canvasPieChat.js
 Created on : 19 Apr, 2013, 3:50:48 PM
 Author     : hareror
 Description: Plugin for draw pie chart using canvas
...
(function($) {
    ...
    $.fn.pieChart = function() {
        ...
        this.each(function(elementIndex) {
            ...
            var canvasWidth = 650;                  // Width of the canvas, in pixels
            ...
            var labelWidth = 50;
            var labelHeight = 80;
            var labelFont = "10px 'Trebuchet MS', Verdana, sans-serif";            
            var spaces = 10;
            var $table = $(this);
            ...
            var drawChart = function() {
                ...
                context.clearRect(0, 0, canvasWidth, canvasHeight-labelHeight);
            ...
            var init = function() {
                ...
                // for adding the pointer
                var labelSpaceCount = spaces;               
                
                for( dataIndex in chartData){
                    
                    context.fillStyle = 'rgb(' + chartColours[dataIndex].join(',') + ')';                    
                    context.fillRect(labelSpaceCount,canvasHeight-40,iconBoxSize,iconBoxSize);
                    labelSpaceCount = labelSpaceCount + iconBoxSize + spaces;                    
                    context.font = labelFont;
                    context.fillText(chartData[dataIndex].label,labelSpaceCount,canvasHeight-30);
                    labelSpaceCount = labelWidth + labelSpaceCount + spaces;                   
